/**
 * @file mbot_omni_ros.h
 * @brief MicroROS integration for MBot Omni
 */
#ifndef MBOT_OMNI_ROS_H
#define MBOT_OMNI_ROS_H
...
// Extern declarations for global state variables defined in mbot_omni_ros.c
